...
import 'package:pantomim_flutter/pages/winner/winner_notifier.dart';
...
class WinnerState extends State<WinnerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<WinnerVm>.reactive(
        viewModelBuilder: () => WinnerVm(),
                              ...
                              children: [
                                NeuButton(
                                  () {
                                    closeGameDialog(context,
                                        title:
                                            "می خواهید همین مسابقه را تکرار کنید؟",
                                        onPress: () {
