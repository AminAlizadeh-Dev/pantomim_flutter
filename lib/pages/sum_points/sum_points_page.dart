...
import 'package:pantomim_flutter/pages/sum_points/sum_points_notifier.dart';
...
class SumPointsState extends State<SumPointsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<SumPointsVm>.reactive(
        viewModelBuilder: () => SumPointsVm(),
