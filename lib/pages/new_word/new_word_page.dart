...
class NewWordState extends State<NewWord> {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<NewWordVm>.reactive(
        viewModelBuilder: () => NewWordVm(),
                    ...
                    child: ListView(controller: _rrectController, children: [
                      Column(
                        children: [
                          ...
                          textFieldWidgets(
                              context, "کلمه مورد نظر تو اینجا بنویس"),
                          Center(
                            child: NeumorphicText(
                              ":امتیاز واژه",
                              style: NeumorphicStyle(
                          ...
                          Container(
                            ...
                            child: NeumorphicButton(
                              padding: EdgeInsets.symmetric(
                                  horizontal: fullWidth(context) / 10,
                                  vertical: 0),
                              onPressed: () {
                              ...
                              child: NeumorphicText(
                                ...
                                textAlign: TextAlign.center,
                                style:
                                    NeumorphicStyle(color: Color(0xff388E3C)),
                              ),
                            ),
                          ),
